    ...
    <div class="">
        <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 px-3">
            ...
            <div class="lg:col-span-2 space-y-10">
                <div class="">
                    <div class="text-3xl text-gray-400">Let's Start your project</div>
                    <div class="text-gray-600 dark:text-gray-50 text-6xl font-bold capitalize">You're the next <span class="text-green-400">Big Project</span></div>
                </div>
